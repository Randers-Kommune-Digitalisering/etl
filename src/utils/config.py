...
ASSET_MANAGEMENT_LIGHT_DB_HOST = os.environ['ASSET_MANAGEMENT_LIGHT_DB_HOST'].rstrip()
ASSET_MANAGEMENT_LIGHT_DB_USER = os.environ['ASSET_MANAGEMENT_LIGHT_DB_USER'].rstrip()
ASSET_MANAGEMENT_LIGHT_DB_PASS = os.environ['ASSET_MANAGEMENT_LIGHT_DB_PASS'].rstrip()
ASSET_MANAGEMENT_LIGHT_DB_DATABASE = os.environ['ASSET_MANAGEMENT_LIGHT_DB_DATABASE'].rstrip()

SSHW_DB_USER = os.environ['SSHW_DB_USER'].rstrip()
