...
SERVER_INVENTORY_DB_USER = os.environ['SERVER_INVENTORY_DB_USER'].rstrip()
SERVER_INVENTORY_DB_PASS = os.environ['SERVER_INVENTORY_DB_PASS'].rstrip()
SERVER_INVENTORY_DB_HOST = os.environ['SERVER_INVENTORY_DB_HOST'].rstrip()
SERVER_INVENTORY_DB_NAME = os.environ['SERVER_INVENTORY_DB_NAME'].rstrip()
