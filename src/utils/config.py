...
CAPA_DB_HOST = os.environ['CAPA_DB_HOST'].rstrip()
CAPA_DB_USER = os.environ['CAPA_DB_USER'].rstrip()
CAPA_DB_PASS = os.environ['CAPA_DB_PASS'].rstrip()
CAPA_DB_DATABASE = os.environ['CAPA_DB_DATABASE'].rstrip()
